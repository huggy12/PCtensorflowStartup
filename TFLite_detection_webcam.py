...
ComputerStatus = 0 # computer is OFF (or 0) at beginning, 1 value used to stop the relay clicking when the computers already turned on and you're sitting at it!
DetectTolerance = 0 # used to add tolerance for brief moments when the camera does not see face even when sitting at the desk
...
#     print("stuck at 3")
    ...
    print("scores are:",scores[0]) # the values in this list go up to near 1.0 when it sees my face
